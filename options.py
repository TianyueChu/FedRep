...
def args_parser():
    ...
    parser.add_argument('--reputation_active_type', type=int, default=0, choices=[0, 1], required=False,
                        help='choose type of reputation model'
                             ...
                             '1: stands for HLL based')
    parser.add_argument('--kappa', type=float, default=0.3, help='positive observations')
    parser.add_argument('--W', type=float, default=2, help='non-information  prior  weight')
    parser.add_argument('--a', type=float, default=0.5, help='prior probability')
    parser.add_argument('--z', type=float, default=0.5, help='time decay')
    parser.add_argument('--s', type=float, default=10, help='sliding window')
